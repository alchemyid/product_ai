...
export const STYLE_PRESETS = [
  ...
  'Minimalist, clean background, soft shadows',
  'Vintage, retro, grainy film look',
  'Cyberpunk, neon lighting, futuristic',
  'Product on a white background',

  // --- Tambahan Profesional ---
  'Luxury editorial, high-fashion lighting, rich contrast',
  'Moody hard light, deep shadows, dramatic tone',
  'Soft dreamy pastel, glowing highlights, gentle aesthetic',
  'High-contrast black and gold luxury look',
  'Natural lifestyle, warm tones, ambient sunlight',
  'Flatlay modern, top-down, color-coordinated props',
  'Macro detail, extreme clarity, shallow depth of field',
  'Commercial eCommerce style, seamless background',
  'Tech aesthetic, clean reflections, glossy metallic finish',
  'Pastel color pop, playful composition, bold shadows',
  'Film noir monochrome, high contrast black and white',
  'Sports action freeze, dynamic motion lighting'
];
