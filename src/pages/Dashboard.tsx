...
const menu: MenuStructure = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'product-swap', title: 'Product Swap' },
      { id: 'ai-stylist', title: 'AI Stylist (Mix & Match)' },
      { id: 'image-2-video', title: 'Image 2 Video' },
      { id: 'voice-generator', title: 'Voice Generator' },
      { id: 'join-video', title: 'Join Video' },
      { id: 'caption-hashtag', title: 'Caption & Hashtag' },
    ],
  },
  {
    id: 'operational',
    title: 'Operational',
    children: [{ id: 'hpp-calculator', title: 'HPP Calculator' }],
  },
];
...
const Placeholder: React.FC<{ title: string }> = ({ title }) => (
  <div className="flex-1 flex items-center justify-center bg-[#0b1120]">
    <div className="text-center text-slate-600">
      ...
      <p className="text-slate-500">This feature is under construction. Check back soon!</p>
    </div>
  </div>
);
...
const Dashboard: React.FC<DashboardProps> = ({ onLogout }) => {
  ...
  const renderContent = () => {
    switch (activeItem) {
      case 'home':
        return <DashboardHomePage menu={menu} setActiveItem={setActiveItem} />;
      case 'fashion-generator':
        return <ProductApp />;
